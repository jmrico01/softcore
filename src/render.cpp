                                    ...
                                    VulkanCompositePipeline* compositePipeline)
{
    ...
    // Create descriptor set
    {
        ...
        const VkDescriptorImageInfo rasterizedImageInfo = {
            .sampler = compositePipeline->sampler,
            .imageView = rasterizedImageView,
        ...
        descriptorWrites[0].pImageInfo = &rasterizedImageInfo;

        const VkDescriptorImageInfo raytracedImageInfo = {
            .sampler = compositePipeline->sampler,
            .imageView = compositePipeline->raytracedImage.view,
            .imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
        };
        ...
        descriptorWrites[1].pImageInfo = &raytracedImageInfo;
